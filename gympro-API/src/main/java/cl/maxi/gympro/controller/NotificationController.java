...
public class NotificationController {
    ...
    public List<Notification> getNotifications(@PathVariable String studentEmail) {
        return notificationRepository.findByStudentEmailOrderByCreatedAtDesc(studentEmail);
    }

    @GetMapping("/{studentEmail}/unread-count")
    public long getUnreadCount(@PathVariable String studentEmail) {
        return notificationRepository.countByStudentEmailAndIsReadFalse(studentEmail);
    }
    ...
    public ResponseEntity<Void> markAllAsRead(@PathVariable String studentEmail) {
        List<Notification> unread = notificationRepository.findByStudentEmailOrderByCreatedAtDesc(studentEmail);
